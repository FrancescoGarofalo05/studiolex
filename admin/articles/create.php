<?php
/**
 * STUDIOLEX - Crea Nuovo Articolo (CRUD - CREATE)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validazione excerpt (opzionale ma se presente deve avere lunghezza minima)
    if (!empty($excerpt) && strlen($excerpt) < 10) {
        $errors['excerpt'] = 'L\'estratto deve contenere almeno 10 caratteri.';
    }
    
    // Se non ci sono errori, crea l'articolo
    if (empty($errors)) {
        // Genera lo slug dal titolo
        $slug = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $title), '-'));
        
        // Verifica se lo slug esiste già e aggiungi un suffisso numerico se necessario
        $original_slug = $slug;
        $counter = 1;
        while (querySingle("SELECT id FROM articles WHERE slug = :slug", [':slug' => $slug])) {
        ...
        try {
            ...
            $_SESSION['success_message'] = 'Articolo creato con successo!';
            ...
            $errors['general'] = 'Errore durante la creazione dell\'articolo. Riprova.';
...
$page_title = 'Nuovo Articolo - StudioLex Admin';
?>
<!DOCTYPE html>
<html lang="it">
<head>
    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-main">
            <div class="admin-header">
                <h1 class="page-title">✏️ Nuovo Articolo</h1>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-checkbox">
                                ...
                                <label for="published">✅ Pubblica immediatamente</label>
                            </div>
